...
from public sources listed in `data/SOURCES.md` (entries 13-15).
...
script consumes only the finished depth COGs. The 311 / ACIS / street-centerline
entries are numbered 13-15 in `data/SOURCES.md` (the CN inputs hold 9-12).
